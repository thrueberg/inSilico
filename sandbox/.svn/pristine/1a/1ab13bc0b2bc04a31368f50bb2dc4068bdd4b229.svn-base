...
//------------------------------------------------------------------------------
template<unsigned DIM, bool SIMPLEX, bool STOKESSTABIL>
struct TypesAndAttributes
{
    ...
    static const unsigned            fieldDegU = (stokesStabil ? 1 : 2 );
    static const unsigned            fieldDegP = 1;
    static const unsigned            fieldDegD = 1;
