...
namespace base{
    namespace asmb{
        ...
        template<typename FIELDTUPLEBINDER,
                 ...
                 typename KERNEL>
        void stiffnessMatrixComputation2( const QUADRATURE& quadrature,
                                          SOLVER& solver,
                                          ...
                                          const bool         incremental = true )
        {
            ...
            typedef StiffnessMatrix2<QUADRATURE,SOLVER,ElementPtrTuple> StiffMat;
...
public:
    ...
    void operator()( const FieldTuple& fieldTuple )
    {
        ...
        kernel_( fieldTuple, quadrature_, elemMatrix );
